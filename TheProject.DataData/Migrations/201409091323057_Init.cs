namespace TheProject.DataData.Migrations
{
    ...
    public partial class Init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MaxGuestsPerBooking = c.Int(nullable: false),
                        NormalSittingTime = c.Int(nullable: false),
                        IsActive = c.Boolean(nullable: false),
                        ImagePath = c.String(),
                        AdminUserId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.RestaurantAdmins", t => t.AdminUserId, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Restaurants", "AdminUserId", "dbo.RestaurantAdmins");
            ...
            DropIndex("dbo.Restaurants", new[] { "AdminUserId" });
